<template>
    <div class="card">
        <div class="card__header">
            ...
            <img class="card__star-img" v-if="product.rating == 0" src='../assets/icons/0.png' alt="">
            <img class="card__star-img" v-if="product.rating == 1" src='../assets/icons/1.png' alt="">
            <img class="card__star-img" v-if="product.rating == 2" src='../assets/icons/2.png' alt="">
            <img class="card__star-img" v-if="product.rating == 3" src='../assets/icons/3.png' alt="">
            <img class="card__star-img" v-if="product.rating == 4" src='../assets/icons/4.png' alt="">
            <img class="card__star-img" v-if="product.rating == 5" src='../assets/icons/5.png' alt="">
...
export default {
    data(){
        return {
            ...
            // linkStar: `../assets/icons/${String(this.product.rating)}.png`
            linkStar: `../assets/icons/1.png`
        }
    },
    props:{
        product: {
    ...
    methods: {
        ...
        onAddProductToCart(product){
            ...
            let newArr = JSON.parse(localStorage.getItem("test"))
